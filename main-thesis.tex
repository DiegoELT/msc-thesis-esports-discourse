...
%% Macros for the annotation-guidelines appendix (Appendix A).
%% Must come after jkureport, which already provides xcolor/tikz/tcolorbox/
%% enumitem/multirow/array/tabularx/booktabs/caption/hyperref.
...
\title{A Human-in-the-Loop Framework for Computational Modeling of Discourse Roles in Esports Commentary}
...
\author{Diego Eduardo~Linares Trelles \suffix{BSc}\matno{12348021}}
...
\supervisor{\prefix{Prof. Dr.} Günter~Wallner}
...
\import{./chapters/}{02-literature-review}
...
\import{./}{91-appendix}
\import{./}{92-annotation-guidelines}
% ...
